...
class animecix:
    ...
    #def fetch_anime_watch_api_url_movie(self, selected_id) -> şuanlık yok 

    def fetch_tr_caption_url(self, season, selected_episode_index, selected_id):
        """
        Belirtilen bölüm/sezon/id için TR altyazı url'sini getirir.
        """
        url = f"https://mangacix.net/secure/related-videos?episode=1&season={season}&titleId={selected_id}&videoId=637113"
        json_data = self._get_json(url)
