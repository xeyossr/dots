...
def select_menu(type: str, choices: list[str], msg: str, tui_menu_with_search_input: bool = True) -> str:
    if type.lower() == "tui":
        if tui_menu_with_search_input:
            return tui.get_selection_from_list(choices, msg, "fuzzy")
        elif not tui_menu_with_search_input:
            return tui.get_selection_from_list(choices, msg, "select")
    elif type.lower() == "rofi":
