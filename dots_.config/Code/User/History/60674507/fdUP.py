from modules.rofi_ui import get_input_from_rofi
from modules.tui_ui import get_input_from_user, get_selection_from_list
...
def search_menu(type: str, msg: str = "Anime Ara"):
    if type.lower() == "tui":
        return get_input_from_user(msg)
    elif type.lower() == "rofi":
        return get_input_from_rofi(["Çık"], msg, rofi_theme, rofi_flags)

def select_menu(type: str, choices: list, msg: str):
    if type.lower() == "tui":
        return get_selection_from_list(choices, msg)
    elif type.lower() == "rofi":
        return get_input_from_rofi(choices, msg, rofi_theme, rofi_flags)