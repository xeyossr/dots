...
[Releases](https://github.com/xeyossr/anitr-cli/releases) sayfasından anitr-cli'yi indirdikten sonra, her çalıştırdığınızda yeni güncellemeleri denetleyecektir. Eğer yeni bir güncelleme varsa, `anitr-cli --update` komutuyla güncelleyebilirsiniz.
