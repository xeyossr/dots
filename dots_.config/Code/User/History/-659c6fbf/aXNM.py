...
def log_anime_details(details: str, state: str, large_text: str, source: str, source_url: str, path="/tmp/anime_details"):
    data = {
...
def start_discord_rpc(client_id=config.discord_client_id, filepath="/tmp/anime_details"):
