...
if __name__ == "__main__":
    ...
    table.add_column("Boot Time", style="bright_cyan", no_wrap=True)  # daha belirgin tarih rengi
    table.add_column("Shutdown", style="bright_magenta", no_wrap=True)
    table.add_column("Uptime", style="green", justify="right")
    table.add_column("Exit", justify="center")  # renk satır içinde ayrıca eklenecek
    table.add_column("Kernel", style="yellow")
    ...
    #console.print(table)
    console.print(Panel(table, title="Boot History", border_style="cyan", padding=(0, 1)))
